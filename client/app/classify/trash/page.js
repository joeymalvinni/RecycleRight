    ...
    return (
        <div className="flex justify-center h-screen pt-12">
            <Classifier
                ...
                links={
                    <div>
                        <li className="underline text-blue-600 hover:text-blue-800"><a href="https://calrecycle.ca.gov/homehazwaste/info/">CalRecycle</a></li>
                        <li className="underline text-blue-600 hover:text-blue-800"><a href="https://www.wm.com/us/en/drop-off-locations">Waste Management</a></li>
                    </div>
                }
            />
        </div>
